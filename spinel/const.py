...
class SPINEL(object):
    ...
    PROP_THREAD_LEADER_NETWORK_DATA = PROP_THREAD_EXT__BEGIN + 13  # < [D]
    PROP_THREAD_STABLE_LEADER_NETWORK_DATA = PROP_THREAD_EXT__BEGIN + 14 # < [D]
    PROP_THREAD_JOINERS = PROP_THREAD_EXT__BEGIN + 15 # < [A(t(ULE))]
    PROP_THREAD_COMMISSIONER_ENABLED = PROP_THREAD_EXT__BEGIN + 16 # < [b]
    PROP_THREAD_BA_PROXY_ENABLED = PROP_THREAD_EXT__BEGIN + 17 # < [b]
    PROP_THREAD_BA_PROXY_STREAM = PROP_THREAD_EXT__BEGIN + 18 # < [dSS]
    PROP_THREAD_DISOVERY_SCAN_JOINER_FLAG = PROP_THREAD_EXT__BEGIN + 19 # < [b]
    PROP_THREAD_DISCOVERY_SCAN_ENABLE_FILTERING = PROP_THREAD_EXT__BEGIN + 20 # < [b]
    PROP_THREAD_DISCOVERY_SCAN_PANID = PROP_THREAD_EXT__BEGIN + 21 # < [S]
    PROP_THREAD_STEERING_DATA = PROP_THREAD_EXT__BEGIN + 22 # < [E]
